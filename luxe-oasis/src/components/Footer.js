    ...
    <div className='footer-container'>
        <section className='footer-subscription'>
            <p className='footer-subscription-heading'>
                Jump into the Adventure! Sign up for the 
                LuxeOasis Newsletter to receive our best vacation 
                deals!
            </p>
        ...
        <div className='social-media-wrap'>
            <div className='footer-logo'>
                <Link to='/' className='social-logo'>
                    LuxeOasis <i className="fa-solid fa-photo-film" />
                </Link>
            </div>
            <small className='website-rights'>LuxeOasis ©2022</small>
